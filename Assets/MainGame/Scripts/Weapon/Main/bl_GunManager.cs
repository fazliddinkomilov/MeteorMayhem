...
public class bl_GunManager : bl_MonoBehaviour
{
    ...
    protected override void Awake()
    {
        ...
        inventory = HeadAnimator.gameObject.GetComponent<WeaponsForwarder>().inventory;
        characterPlayer = HeadAnimator.gameObject.GetComponent<WeaponsForwarder>().characterPlayer;
    }
    ...
    public int SwitchNext()
    {
        ...
        characterPlayer.RefreshWeaponSetup();
    ...
    public void ChangeTo(int AllWeaponsIndex)
    {
        ...
        inventory.Equip(AllWeaponsIndex);
        characterPlayer.RefreshWeaponSetup();
    }
